...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--adapter_rank', default=8, type=int,)
    subparsers.add_argument('--adapter_depth', default=5, type=int,)
    subparsers.add_argument('--adapter_momentum', default=0.1, type=float,)
    subparsers.add_argument('--adapter_type', default='continual', type=str,)
    subparsers.add_argument('--continual_type', default='slow_learner', type=str)
    subparsers.add_argument('--slow_lr', default=0.01, type=float)
    subparsers.add_argument('--fix_epochs', default=10, type=int)
    # ViT parameters
