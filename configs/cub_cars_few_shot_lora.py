...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--datasets', default=['Split-Dogs', 'Split-Aircraft', 'Split-Cars196', 'Split-CUB200'], type=list, nargs="*", help="datasets")
    subparsers.add_argument('--continual_classes_per_dataset', default=[60, 50, 100, 100], type=int, nargs="*", help="num continual classes per dataset")
    subparsers.add_argument('--few_shot_classes_per_dataset', default=[60, 50, 96, 100], type=int, nargs="*", help="num few shot classes per dataset")
    subparsers.add_argument('--tasks_per_dataset', default=[5, 5, 5, 5], type=int, nargs="*", help="num tasks per dataset")
    ...
    subparsers.add_argument('--train_hide', action="store_true", help="train hide model")
    subparsers.add_argument('--train_mixture', action="store_true", help="train mixture model")
    subparsers.add_argument('--train_ood', action="store_true", help="train ood detection")
    ...
    subparsers.add_argument('--continual_model_output_dir', default='./output/continual_model', type=str, help='shared model output dir')
    ...
    subparsers.add_argument('--fs_lr', default=0.01, type=float, help='fs lr')
    subparsers.add_argument('--cl_lr', default=[0.01, 0.01, 0.01, 0.01], type=float, nargs="*", help='cl lr')
    subparsers.add_argument('--fs_backbone', default='vanilla+shared', type=str, choices=['vanilla', 'shared', 'vanilla+shared', 'continual'], help='fs backbone')
    subparsers.add_argument('--few_shot_dataset_idx', default=0, type=int, help='few shot dataset idx')
    subparsers.add_argument('--few_class_idx', default=[160, 161, 162, 163, 164], type=int, nargs="*", help='few class idx')
    subparsers.add_argument('--cluster_threshold', default=1.0, type=float)
